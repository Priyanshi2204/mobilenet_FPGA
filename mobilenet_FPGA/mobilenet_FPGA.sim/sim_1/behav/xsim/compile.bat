...
REM
REM Generated by Vivado on Wed Feb 18 01:27:09 +0530 2026
...
echo "xvlog --incr --relax -prj tb_aadya_vlog.prj"
call xvlog  --incr --relax -prj tb_aadya_vlog.prj -log xvlog.log
