...
REM
REM Generated by Vivado on Sat Feb 14 16:32:46 +0530 2026
...
echo "xvlog --incr --relax -prj quantizer_vlog.prj"
call xvlog  --incr --relax -prj quantizer_vlog.prj -log xvlog.log
